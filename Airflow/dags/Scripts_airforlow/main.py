...
def main():
    ...
    sc = SparkSession(sc)
    list_of_dataframes = []
    for file in os.listdir(r'/home/sofienkhanfir/Bureau/Projet/data_candidat'):
        print(file)
    ...
    union_df.toPandas().to_csv(r'/home/sofienkhanfir/Bureau/Projet/final_data/final_data.csv',index=False)
